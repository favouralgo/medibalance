            ...
            <form id="registrationForm">
                <div class="form-row">
                    <div class="form-group">
                        <input type="text" id="admin_firstname" placeholder="Enter your first name" required>
                    </div>
                    <div class="form-group">
                        <input type="text" id="admin_lastname" placeholder="Enter your last name" required>
                    </div>
                </div>
                <div class="form-row">
                    <div class="form-group">
                ...
                <div class="form-row">
                    <div class="form-group">
                        <input type="text" id="admin_country" placeholder="Enter your country" required>
                    </div>
                    <div class="form-group">
                        <input type="text" id="admin_city" placeholder="Enter your city" required>
                    </div>
                </div>
                <div class="form-row">
                    <div class="form-group">
                        <input type="text" id="admin_address" placeholder="Enter your address" required>
                    </div>
                    <div class="form-group">
                        <input type="text" id="admin_phonenumber" placeholder="Enter your contact number" required>
                    </div>
                </div>
                <div class="form-row">
                    <div class="form-group password-container">
                        <input type="password" id="admin_password" placeholder="Enter your password" required>
                        <span toggle="#admin_password" class="fa fa-fw fa-eye toggle-password"></span>
                    </div>
                    <div class="form-group password-container">
